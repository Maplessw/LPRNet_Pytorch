...
def get_parser():
    ...
    parser.add_argument('--train_img_dirs', default="D:/bishe/code/lprnet_data/train", help='the train images path')
    parser.add_argument('--test_img_dirs', default="D:/bishe/code/lprnet_data/val", help='the test images path')
    ...
    parser.add_argument('--save_interval', default=5, type=int, help='interval for save model state dict')
