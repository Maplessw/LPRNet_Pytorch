...
Date: 2024-03-20 20:58:08
LastEditors: maple
LastEditTime: 2024-03-21 16:23:34
Description: 
'''
import cv2
import os
...
path = r'D:\bishe\code\yolov8-train\data\images\CCPD19_1'  # 改成自己的车牌路径
...
for filename in os.listdir(path):
    ...
    cv2.imencode('.jpg', img)[1].tofile(r"D:\bishe\code\lprnet-train\data\train\{}.jpg".format(result))
    # 图片中文名会报错
