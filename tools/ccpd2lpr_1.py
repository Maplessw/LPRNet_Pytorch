...
LastEditors: maple
LastEditTime: 2024-03-21 15:41:39
Description: 
'''
import cv2
import os
...
path = r'D:\bishe\code\lprnet-train\data\val\images'  # 改成自己的车牌路径
...
for filename in os.listdir(path):
    ...
    cv2.imencode('.jpg', img)[1].tofile(r"D:\bishe\code\lprnet-train\data\val\{}.jpg".format(result))
    # 图片中文名会报错
